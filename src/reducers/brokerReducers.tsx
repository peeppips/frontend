...
export const getBrokerByIdReducer = (
  state: BrokerByIdState = { loading: false, broker: {id:"",name:""} },
  action: { type: string; payload: Broker; error?: string }
): BrokerByIdState => {
  switch (action.type) {
    case GET_BROKER_BY_ID_REQUEST:
      return { ...state, loading: true, broker: {id:"",name:""} };
...
export const createBrokerReducer = (
  state: CreateBrokerState = { loading: false, broker: {id:"",name:""} },
  action: { type: string; payload: Broker; error?: string }
): CreateBrokerState => {
  switch (action.type) {
...
export const updateBrokerReducer = (
  state: UpdateBrokerState = { loading: false, broker: {id:"",name:""} },
  action: { type: string; payload: Broker; error?: string }
): UpdateBrokerState => {
  switch (action.type) {
