...
export const userRegisterReducer = (state = {loading:false}, action: { type: any; payload: any }) => {
  switch (action.type) {
...
export const userDetailsReducer = (state = { user: {} }, action: { type: any; payload: any }) => {
  switch (action.type) {
    ...
    case USER_DETAILS_SUCCESS:
      return { loading: false, user: action.payload.user,projects:action.payload.projects }
...
export const userListReducer = (state = { users: [] }, action: { type: any; payload: any }) => {
  switch (action.type) {
...
export const userUpdateReducer = (state = { user: {} }, action: { type: any; payload: any }) => {
  switch (action.type) {
