...
export const GET_REFERRAL_BY_USER_REQUEST = 'GET_REFERRAL_BY_USER_REQUEST';
export const GET_REFERRAL_BY_USER_SUCCESS = 'GET_REFERRAL_BY_USER_SUCCESS';
export const GET_REFERRAL_BY_USER_FAILURE = 'GET_REFERRAL_BY_USER_FAILURE';
