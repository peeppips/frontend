...
export const register = (userInfoDetails:{firstName:string, secondName:string, email:string,  password:string, image:string, profile_pic:string,strategyType:string}) => async (dispatch: Dispatch<AnyAction>) => {
  try {
