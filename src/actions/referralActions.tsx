...
export const deleteBroker = (referalId: any) => async (dispatch: (arg0: { type: string; payload?: any; }) => void) => {
  try {
...
export const updateBroker = (referalId: any, updatedData: any) => async (dispatch: (arg0: { type: string; payload?: any; }) => void) => {
  try {
